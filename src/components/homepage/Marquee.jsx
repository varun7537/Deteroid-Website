    ...
    <div style={{ padding:"40px 0", background:T.ink, overflow:"hidden" }}>
      <div style={{ display:"flex", whiteSpace:"nowrap", animation:"marquee 22s linear infinite", width:"max-content" }}>
        {doubled.map(([label, accent], i) => (
          <span key={i} style={{ display:"inline-flex", alignItems:"center", gap:16, padding:"0 48px", fontFamily:T.syne, fontSize:13, fontWeight:700, letterSpacing:"0.12em", textTransform:"uppercase", color: accent ? "rgba(255,255,255,0.7)" : "rgba(255,255,255,0.35)" }}>
